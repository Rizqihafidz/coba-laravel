    ...
    <div class="row justify-content-center mb-5">
        <div class="col-md-8">
            <article>
                ...
                <p class="mt-3">Oleh. <a class ="text-decoration-none">{{ $post->penulis }}</a> Tentang <a href="/potensi" class ="text-decoration-none">Program Desa</a></p>
                <img src="https://source.unsplash.com/1200x400?nature" alt="" class="img-fluid">
                <article class="my-3 fs-5">
                    <p>Tanggal Mulai Program: <a class ="text-decoration-none">{{ $post->tanggal->isoFormat('dddd, D MMMM Y') }}</a> </p>
                </article>
                <article class="my-3 fs-5">
                    <p>{!! $post->deskripsi !!}</p>
                </article>

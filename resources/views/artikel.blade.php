...
@if ($posts->count())
<div class="card mb-3">
    <img src="https://source.unsplash.com/1200x400?nature" class="card-img-top" alt="">
    <div class="card-body text-center">
      ...
      <p class="card-text">{!! Str::words($posts[0]->deskripsi,20) !!}</p>
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">{!! Str::words($post->deskripsi,20) !!}</p>
                  @if($title != "Berita")

...
<div class="row mb-4">
  ...
  <div class="col-md-6">
    <div class="card mb-3" style="max-width: 100%;">
      <div class="row g-0">
        <div class="col-md-4">
          <img src="https://source.unsplash.com/200x200?person" class="img-fluid" alt="...">
        </div>
        <div class="col-md-8">
          <div class="card-body">
            ...
            <div class="col align-self-end">
              <p class="card-text">
                ...
                <small class="text-muted">Tanggal Menjabat : {{ $aparatur->tanggal_menjabat->isoFormat('dddd, D MMMM Y') }}</small>
              </p>
            </div>
          </div>
        </div>
